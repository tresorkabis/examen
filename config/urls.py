...
urlpatterns = [
    ...
    path('sessions/<int:pk>/grilles/<int:grille_pk>/', session_grille_apercu, name='session_grille_apercu'),
    path('sessions/<int:pk>/grilles/<int:grille_pk>/retirer/', session_grille_retirer, name='session_grille_retirer'),
